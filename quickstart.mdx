...
<Tabs>
  <Tab title="npm">
    <CodeBlock>npm install @ogify/core @ogify/templates</CodeBlock>
  </Tab>
  <Tab title="pnpm">
    <CodeBlock>pnpm add @ogify/core @ogify/templates</CodeBlock>
  </Tab>
  <Tab title="yarn">
    <CodeBlock>yarn add @ogify/core @ogify/templates</CodeBlock>
  </Tab>
</Tabs>
